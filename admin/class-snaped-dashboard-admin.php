 ...
 * functionality, then refer to `public/class-cares-openlayers.php`
 *
 * @package   CARES_SnapEd_Dashboard_Admin
 * @author  AuthorName
 */
class CARES_SnapEd_Dashboard_Admin {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'cares-openlayers';
	...
	public function add_action_links( $links ) {
		...
		return array_merge(
			array(
				'settings' => '<a href="' . admin_url( 'options-general.php?page=' . $this->plugin_slug ) . '">' . __( 'Settings', 'cares-openlayers' ) . '</a>'
			),
			$links
		);
	...
	public function report_custom_plugin( $custom_plugins, $group_id ) {
		if ( $group_id == cares_ol_get_group_id() ) {
